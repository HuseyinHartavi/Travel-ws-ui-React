...
const DetailPackage2 = () =>{
const[selectedImage, setSelectedImage] = useState('../media/detail-img2.jpg')
useEffect(()=>{
    window.scrollTo(0,0);
  })
    return <>
      ...
      <section class="detail">
        <div class="detail__card card">
          ...
          <div class="detail__card-img-list">
            ...
            />
            <img
              src="../media/detail-roma1.jpg"
              alt=""
              onClick={()=> setSelectedImage("../media/detail-roma1.jpg")}
              class={`detail__card-img-item ${selectedImage === '../media/detail-roma1.jpg' ? 'active' : ''}`}
            />
            <img
              src="../media/detail-roma2.jpg"
              alt=""
              onClick={()=> setSelectedImage("../media/detail-roma2.jpg")}
              class={`detail__card-img-item ${selectedImage === '../media/detail-roma2.jpg' ? 'active' : ''}`}
            />
            <img
              src="../media/detail-roma3.jpg"
              alt=""
              onClick={()=> setSelectedImage("../media/detail-roma3.jpg")}
              class={`detail__card-img-item ${selectedImage === '../media/detail-roma3.jpg4' ? 'active' : ''}`}
            />
          </div>
