      ...
      <section class="detail">
        <div class="detail__card card">
          ...
          <div class="detail__card-img-list">
            <img
              src="../media/detail-img7.jpg"
              alt=""
              onClick={()=> setSelectedImage("../media/detail-img7.jpg")}
              class={`detail__card-img-item ${selectedImage === '../media/detail-img7.jpg' ? 'active' : ''}`}
            />
            <img
            ...
            />
            <img
              src="../media/detail-img8.jpg"
              alt=""
              onClick={()=> setSelectedImage("../media/detail-img8.jpg")}
              class={`detail__card-img-item ${selectedImage === '../media/detail-img8.jpg' ? 'active' : ''}`}
            />
            <img
